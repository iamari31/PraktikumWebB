...
<body>
<center>
    <h1>Daftar Rekomendasi film terbaru mei 2020</h1>
    <hr/><br><br><br><br>
    <table border="10" bordercolor="white">
        <?php
            ...
            $tampil = mysqli_query($conn, "SELECT * FROM menu_film ORDER BY id ASC LIMIT $mulai, $batas") or die (mysqli_error($conn));
            $no = $mulai+1;
    ...
    <?php
        $hitung = mysqli_query($conn,"SELECT * FROM menu_film") or die (mysqli_error($conn));
