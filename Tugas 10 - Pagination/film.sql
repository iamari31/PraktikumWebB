...
--
-- Table structure for table `menu_film`
--

CREATE TABLE `menu_film` (
  `id` int(11) NOT NULL,
  `nama_film` varchar(128) NOT NULL,
  `image` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `menu_film`
--

INSERT INTO `menu_film` (`id`, `nama_film`, `image`) VALUES
...
--
-- Indexes for table `menu_film`
--
ALTER TABLE `menu_film`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `menu_film`
--
ALTER TABLE `menu_film`
