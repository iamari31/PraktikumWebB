	...
	<div class="main">
		...
		<div class="nav">
			<ul>
				...
				<li>
					<a href="tentang.html"><h3>TENTANG</h3></a>
				</li>
				<li>
					<a href="galeri.html"><h3>GALERI BUKU</h3></a>
				</li>
				<li>
					<a href="kontak.html"><h3>KONTAK</h3></a>
				</li>
			</ul>
		</div>
		<br>
		<div class="content">
			<h1>Kontak Web Developer</h1>
            <div class="garis"></div>
            <h2>Audini Nifira Putri</h2>
